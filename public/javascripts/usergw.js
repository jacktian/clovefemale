$(function(){
       ...
       if(curPage == pageNum){
		...
		if($(this).hasClass('prevPage')){	 
			var page = curPage - 1;
			// alert(page);
			window.location.href=localhost+"/GestationalWeightAction/getWeightDataByDate2?userId="+userId+"&userName="+userName+"&sDate="+sDate+"&eDate="+eDate+"&curpage="+page;
		...
		/*如果点击下一页*/
         ...
         window.location.href=localhost+"/GestationalWeightAction/getWeightDataByDate2?userId="+userId+"&userName="+userName+"&sDate="+sDate+"&eDate="+eDate+"&curpage="+nextPage;
         }
