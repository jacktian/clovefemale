$(function(){
       ...
       if(curPage == pageNum){
		...
		if($(this).hasClass('prevPage')){	 
			var page = curPage - 1;
			// alert(page);
			window.location.href = localhost+"/Application/listUserNotebook?&curpage="+page;
		...
		/*如果点击下一页*/
			...
			window.location.href = localhost+"/Application/listUserNotebook?&curpage="+page;
         	...
         	window.location.href = localhost+"/Application/listUserNotebook?&curpage="+nextPage;
         }
	...
	window.location.href=localhost+"/RandomNote/findNoteBookByUser?userId="+uId+"&userName="+userName;
	}
    $(document).on('click','.submitBtn',findNbByUser);
});