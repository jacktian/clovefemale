$(function(){
       ...
       if(curPage == pageNum){
		...
		if($(this).hasClass('prevPage')){	 
			var page = curPage - 1;
			// alert(page);
			window.location.href = localhost+"/MedicineAction/findMbyMB?mbid="+mbId+"&mbname="+mbFlag+"&curpage="+page;
		...
		/*如果点击下一页*/
			...
			window.location.href = localhost+"/MedicineAction/findMbyMB?mbid="+mbId+"&mbname="+mbFlag+"&curpage="+page;
         	...
         	window.location.href = localhost+"/MedicineAction/findMbyMB?mbid="+mbId+"&mbname="+mbFlag+"&curpage="+nextPage;
         }
